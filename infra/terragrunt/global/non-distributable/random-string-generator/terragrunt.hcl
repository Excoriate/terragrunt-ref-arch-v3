...
include "shared" {
  path           = "${get_terragrunt_dir()}/../../../_shared/_units/random_string_generator.hcl"
  expose         = true
  merge_strategy = "deep"
}
...
locals {
  ...
  tf_module_local_path = "${include.shared.locals.git_base_url_local}/random-string-generator"
  # tf_module_local_path       = "${include.shared.locals.git_base_url}/random-string-generator"
